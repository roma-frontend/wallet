...
import { ArrowDownLeft, ArrowUpRight, Sparkles, Loader2, X, Paperclip, Plus, Tag } from "lucide-react";
...
export function TransactionForm({ initial, defaultType, prefillText, onSuccess }: Props) {
  ...
  /* Auto-suggest a category from the note, learned from past transactions. */
